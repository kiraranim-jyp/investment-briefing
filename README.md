...
## 7. Sprint 2~4 로드맵 (미구현)

명세에서 제안된 다음 단계. 필요할 때 별도 세션에서 이어서 진행:
- Sprint 2: 뉴스 감성분석, 실적추이 자동요약, 기술적지표(RSI/MACD/볼린저), 이벤트 캘린더, Bull/Base/Bear 시나리오
- Sprint 3: 목표가/분할매수·매도 전략, 관심종목 알림, 포트폴리오 비중분석, 종목 비교, 매매 일지
- Sprint 4: AI 투자 토론, 반대의견 생성, 신뢰도 표시, 과거 예측 검증, 투자성향 맞춤 리포트, PDF 생성
